<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="Customerphnum" v-model="item.customerphnum" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <String label="OderStatus" v-model="item.oderStatus" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
