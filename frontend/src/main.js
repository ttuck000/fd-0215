...
pluralCaseList.push( {plural: "reviewSearches", pascal: "ReviewSearch"} )
pluralCaseList.push( {plural: "kakaotalks", pascal: "Kakaotalk"} )
pluralCaseList.push( {plural: "orderSearches", pascal: "OrderSearch"} )
